...
export function ReportModal({ onClose, meta, brakeHistory = [], hotAxleCoach, rawHamsData = [] }: ReportModalProps) {
  ...
  /* ── Filtered data (always computed, auto-refreshes on preset change) ── */
      ...
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-gradient-to-r from-slate-900 to-indigo-900 text-white">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={handleCSV}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-white text-xs font-bold transition-all shadow-md"
            ...
            <button
              onClick={handlePrint}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-indigo-500 hover:bg-indigo-400 text-white text-xs font-bold transition-all shadow-md"
